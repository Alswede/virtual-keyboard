import { digits, keys, controls } from './src/keyboard.js';
...
footer.innerHTML = '<p>For сhange language - use keyboard-combination "Ctrl + Alt Left" or "ENG/RU" <br >OS Windows<br></p>';
